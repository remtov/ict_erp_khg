		...
		<div id="page-content-wrapper">
			...
			<form action="/member/memberUpdate" method="post">
				<table class="table table-bordered">
					...
					<tr>
						<th>이메일</th>
						<td><input type="email" name="miEmail"
							value="${member.miEmail}"></td>
					</tr>
					<tr>
						<th>폰번호</th>
						<td><input type="number" name="miPhone"
							value="${member.miPhone}"></td>
					</tr>
					<tr>
						<th>우편번호</th>
						<td><input type="number" name="miZipcode"
							value="${member.miZipcode}"></td>
					</tr>
					<tr>
						<th>주소</th>
						<td><input type="text" name="miAddress1"
							value="${member.miAddress1}"></td>
					</tr>
					<tr>
						<th>상세주소</th>
						<td><input type="text" name="miAddress2"
							value="${member.miAddress2}"></td>
					</tr>
					<tr>
						<th>부서</th>
					...
					<tr>
						<td colspan="2"><button>사원수정</button>
							<button data-action="/member/memberDelete">사원삭제</button></td>
					</tr>
				</table>
